...
boolean ROTATE_LEFT = false;  //User is pressing <-
boolean ROTATE_RIGHT = false; //User is pressing ->
boolean MOVE_FORWARD = false; //User is pressing ^ arrow
boolean SPACE_BAR = false;    //User is pressing space bar
